...
default[:gecos_ws_mgmt][:network_mgmt][:sssd_res][:support_os] = []
...
default[:gecos_ws_mgmt][:software_mgmt][:software_sources_res][:support_os] = []
...
default[:gecos_ws_mgmt][:software_mgmt][:package_res][:support_os] = []
...
default[:gecos_ws_mgmt][:misc_mgmt][:auto_updates_res][:support_os] = []
...
default[:gecos_ws_mgmt][:misc_mgmt][:tz_date_res][:support_os] = []
...
default[:gecos_ws_mgmt][:misc_mgmt][:power_conf_res][:support_os] = []
...
default[:gecos_ws_mgmt][:misc_mgmt][:local_users_res][:support_os] = []
...
default[:gecos_ws_mgmt][:misc_mgmt][:local_file_res][:support_os] = []
...
default[:gecos_ws_mgmt][:misc_mgmt][:scripts_launch_res][:support_os] = []
...
default[:gecos_ws_mgmt][:misc_mgmt][:local_groups_res][:support_os] = []
...
default[:gecos_ws_mgmt][:misc_mgmt][:local_admin_users_res][:support_os] = []
...
default[:gecos_ws_mgmt][:users_mgmt][:user_apps_autostart_res][:support_os] = []
...
default[:gecos_ws_mgmt][:users_mgmt][:user_shared_folders_res][:support_os] = []
...
default[:gecos_ws_mgmt][:users_mgmt][:file_browser_res][:support_os] = []
...
default[:gecos_ws_mgmt][:users_mgmt][:desktop_background_res][:support_os] = []

default[:gecos_ws_mgmt][:users_mgmt][:user_launchers_res][:users] = {}
default[:gecos_ws_mgmt][:users_mgmt][:user_launchers_res][:job_ids] = []
default[:gecos_ws_mgmt][:users_mgmt][:user_launchers_res][:support_os] = []
...
default[:gecos_ws_mgmt][:users_mgmt][:shutdown_options_res][:support_os] = []
