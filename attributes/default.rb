...
default[:gecos_ws_mgmt][:misc_mgmt][:chef_conf_res][:support_os] = ["GECOS V3", "GECOS V2", "Gecos V2 Lite"]
default[:gecos_ws_mgmt][:misc_mgmt][:gcc_res][:support_os] = ["GECOS V3", "GECOS V2", "Gecos V2 Lite"]
...
default[:gecos_ws_mgmt][:network_mgmt][:mobile_broadband_res][:support_os] = ["GECOS V3", "GECOS V2","Gecos V2 Lite"]
...
default[:gecos_ws_mgmt][:network_mgmt][:sssd_res][:support_os] = ["GECOS V3", "GECOS V2", "Gecos V2 Lite"]
...
default[:gecos_ws_mgmt][:software_mgmt][:software_sources_res][:support_os] = ["GECOS V3", "GECOS V2", "Gecos V2 Lite"]
...
default[:gecos_ws_mgmt][:software_mgmt][:package_res][:support_os] = ["GECOS V3", "GECOS V2", "Gecos V2 Lite", "Ubuntu 14.04.1 LTS"]
...
default[:gecos_ws_mgmt][:software_mgmt][:package_profile_res][:support_os] = ["GECOS V3", "GECOS V2","Gecos V2 Lite", "Ubuntu 14.04.1 LTS"]

default[:gecos_ws_mgmt][:software_mgmt][:package_version_lock_res][:package_list] = []
default[:gecos_ws_mgmt][:software_mgmt][:package_version_lock_res][:job_ids] = []
default[:gecos_ws_mgmt][:software_mgmt][:package_version_lock_res][:updated_by] = {}
default[:gecos_ws_mgmt][:software_mgmt][:package_version_lock_res][:support_os] = ["GECOS V3", "GECOS V2", "Gecos V2 Lite", "Ubuntu 14.04.1 LTS"]
...
default[:gecos_ws_mgmt][:software_mgmt][:app_config_res][:support_os] = ["GECOS V3", "GECOS V2", "Gecos V2 Lite"]
...
default[:gecos_ws_mgmt][:software_mgmt][:appconfig_libreoffice_res][:support_os] = ["GECOS V3", "GECOS V2", "Gecos V2 Lite"]
...
default[:gecos_ws_mgmt][:software_mgmt][:appconfig_thunderbird_res][:support_os] = ["GECOS V3", "GECOS V2", "Gecos V2 Lite"]
...
default[:gecos_ws_mgmt][:software_mgmt][:appconfig_firefox_res][:support_os] = ["GECOS V3", "GECOS V2", "Gecos V2 Lite"]
...
default[:gecos_ws_mgmt][:printers_mgmt][:printers_res][:support_os] = ["GECOS V3", "GECOS V2", "Gecos V2 Lite"]
...
default[:gecos_ws_mgmt][:misc_mgmt][:auto_updates_res][:support_os] = ["GECOS V3", "GECOS V2", "Gecos V2 Lite"]
...
default[:gecos_ws_mgmt][:misc_mgmt][:boot_lock_res][:support_os] = ["GECOS V3", "GECOS V2", "Gecos V2 Lite", "Ubuntu 14.04.1 LTS"]
...
default[:gecos_ws_mgmt][:misc_mgmt][:tz_date_res][:support_os] = ["GECOS V3", "GECOS V2", "Gecos V2 Lite"]
...
default[:gecos_ws_mgmt][:misc_mgmt][:power_conf_res][:support_os] = ["GECOS V3", "GECOS V2", "Gecos V2 Lite"]
...
default[:gecos_ws_mgmt][:misc_mgmt][:local_users_res][:support_os] = ["GECOS V3", "GECOS V2", "Gecos V2 Lite"]
...
default[:gecos_ws_mgmt][:misc_mgmt][:local_file_res][:support_os] = ["GECOS V3", "GECOS V2", "Gecos V2 Lite"]
...
default[:gecos_ws_mgmt][:misc_mgmt][:scripts_launch_res][:support_os] = ["GECOS V3", "GECOS V2", "Gecos V2 Lite"]
...
default[:gecos_ws_mgmt][:misc_mgmt][:local_groups_res][:support_os] = ["GECOS V3", "GECOS V2", "Gecos V2 Lite"]
...
default[:gecos_ws_mgmt][:misc_mgmt][:local_admin_users_res][:support_os] = ["GECOS V3", "GECOS V2", "Gecos V2 Lite"]
...
default[:gecos_ws_mgmt][:misc_mgmt][:cert_res][:support_os] = ["GECOS V3", "GECOS V2", "Gecos V2 Lite"]
...
default[:gecos_ws_mgmt][:users_mgmt][:user_apps_autostart_res][:support_os] = ["GECOS V3", "GECOS V2", "Gecos V2 Lite"]
...
default[:gecos_ws_mgmt][:users_mgmt][:web_browser_res][:support_os] = ["GECOS V3", "GECOS V2", "Gecos V2 Lite"]
default[:gecos_ws_mgmt][:users_mgmt][:web_browser_res][:ver_threshold] = 4

default[:gecos_ws_mgmt][:users_mgmt][:email_client_res][:users] = {}
default[:gecos_ws_mgmt][:users_mgmt][:email_client_res][:job_ids] = []
default[:gecos_ws_mgmt][:users_mgmt][:email_client_res][:support_os] = ["GECOS V3", "GECOS V2", "Gecos V2 Lite"]
...
default[:gecos_ws_mgmt][:users_mgmt][:user_launchers_res][:support_os] = ["GECOS V3", "GECOS V2", "Gecos V2 Lite"]
...
default[:gecos_ws_mgmt][:users_mgmt][:user_mount_res][:support_os] = ["GECOS V3", "GECOS V2", "Gecos V2 Lite"]
...
default[:gecos_ws_mgmt][:users_mgmt][:shutdown_options_res][:support_os] = ["GECOS V3", "GECOS V2", "Gecos V2 Lite"]


default[:gecos_ws_mgmt][:users_mgmt][:user_alerts_res][:users] = {}
default[:gecos_ws_mgmt][:users_mgmt][:user_alerts_res][:job_ids] = []
default[:gecos_ws_mgmt][:users_mgmt][:user_alerts_res][:support_os] = ["GECOS V3", "GECOS V2","Gecos V2 Lite"]

default[:gecos_ws_mgmt][:users_mgmt][:mimetypes_res][:users] = {}
default[:gecos_ws_mgmt][:users_mgmt][:mimetypes_res][:job_ids] = []
default[:gecos_ws_mgmt][:users_mgmt][:mimetypes_res][:support_os] = ["GECOS V3", "GECOS V2", "Gecos V2 Lite"]
...
default[:gecos_ws_mgmt][:misc_mgmt][:remote_shutdown_res][:support_os] = ["GECOS V3", "GECOS V2", "Gecos V2 Lite"]
